  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 p-6">
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 15% 20%, rgb(15 109 92 / 0.10), transparent 45%), radial-gradient(circle at 85% 80%, rgb(180 83 9 / 0.08), transparent 45%)',
        }}
      />
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
        <div className="border-b border-slate-100 px-8 pt-9 pb-7 text-center">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-600 text-white shadow-sm">
            <Icon name="leaf" className="h-6 w-6" strokeWidth={2} />
          </div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">peopleFirst</h1>
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700" htmlFor="loginUsername">
                Username
              </label>
              <input
                id="loginUsername"
                ...
                className="w-full rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none"
              />
            </div>

            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700" htmlFor="loginPassword">
                Password
              </label>
              <input
                id="loginPassword"
            ...
            {preview && (
              <div className={`flex items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-center text-xs font-semibold ring-1 ring-inset ${preview.color}`}>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full rounded-lg bg-indigo-600 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {statusText}
            </button>
          </form>
          ...
          <div className="mt-6 border-t border-slate-200 pt-5">
            <div className="mb-3 text-center text-xs font-semibold tracking-wide text-slate-400 uppercase">
              1-Click Role Accounts &middot; password123
            </div>
